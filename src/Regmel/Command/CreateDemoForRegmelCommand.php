...
class CreateDemoForRegmelCommand extends Command
{
    ...
    private function createPhasesForMunicipality(Opportunity $opportunityForMunicipality): void
    {
        ...
        $phase1Municipality->setStartDate(new DateTime('2025-05-30'));
        $phase1Municipality->setEndDate(new DateTime('2025-06-30'));
    ...
    private function createPhasesForCompany(Opportunity $opportunity): void
    {
        ...
        $phase1->setStartDate(new DateTime('2025-05-30'));
        $phase1->setEndDate(new DateTime('2025-06-30'));
        $phase1->setCriteria([
            'oficio' => true,
        ]);
